      ...
      <div>
        ...
        <div className="">
          {orders.map((order, index) => (
            <div
              className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] gap-3 items-start border-2 border-gray-200 p-5 md:p-8 my-3 md:my-4 text-xs xm:text-sm text-gray-700"
              key={index}
            >
              <img className="w-12" src={images.Parcel} alt="" />
              <div>
                <div className="">
